...
<body>
 	<div class="generic-container">
		...
		<div class="well lead"><spring:message code="register.user"/></div>
			...
			<div class="row">
				<div class="form-actions floatRight">
					<c:choose>
						...
						<c:otherwise>
							<input type="submit" value="<spring:message code="register"/>" class="btn btn-success"/> <a  class="btn btn-danger custom-width" href="<c:url value='/list' />"><spring:message code="cancel"/> </a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
